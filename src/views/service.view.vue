  ...
  <div class="">
      ...
      <div class="relative">
        ...
        <div class="flex items-center gap-2 absolute top-[55%] left-10">
          <h3 class="text-[20px] font-[600] text-primaryColor">
            FutureNội dung chất lượng
          </h3>
        </div>
      </div>
      <h1 class="text-[40px] text-gray-800 font-[700] mb-[40px]">
        Thu Hút Sự Chú Ý Và Thúc Đẩy Chuyển Đổi Với <span class="text-primaryColor">Marketing</span>
      </h1>
      <ul class="grid grid-cols-3 grid-rows-3 gap-8 ">
    ...
    <section
      ...
      <h1 class="text-[40px] text-gray-800 font-[700] mb-[20px]">
        Quy trình làm việc
        <span class="text-primaryColor">hiệu quả</span>
      </h1>
