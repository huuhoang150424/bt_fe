...
<div>
    ...
    <div class="space-y-8">
        ...
        <div class="bg-white rounded-xl shadow p-4">
            ...
            <div class="space-y-4">
                <div v-for="(recent, idx) in recentPosts" :key="idx" class="flex gap-3 items-start">
        ...
        <div class="bg-white rounded-xl shadow p-4">
            ...
            <div class="flex flex-wrap gap-3">
                <span v-for="(tag, idx) in popularTags" :key="idx" class="px-3 py-1 text-sm border border-gray-300 rounded-full hover:bg-gray-100 cursor-pointer">
                    {{ tag }}
                </span>
            </div>
        </div>
